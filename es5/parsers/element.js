  ...
  _createClass(ElementParser, [{
    ...
    value: function getAttributeFilter() {
      ...
      if (whiteList && whiteList.length) {
        return function (key) {
          return _util2['default'].contains(whiteList, key);
        };
      } else {
        return function (key) {
          return !_util2['default'].contains(blackList, key);
        };
      }
    }
  }]);
